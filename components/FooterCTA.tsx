...
export const FooterCTA: React.FC<FooterCTAProps> = ({ onOpenTeacherForm, onOpenSchoolForm }) => {
    ...
    <footer>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2">
            <div className="bg-gradient-to-br from-teal-600 to-cyan-700 text-white p-16 lg:p-24 flex flex-col justify-center items-start text-left relative overflow-hidden">
                ...
                <Button 
                  variant="primary" 
                  className="bg-white text-teal-700 hover:bg-teal-50 hover:shadow-none border-none relative z-10"
                  onClick={onOpenTeacherForm}
                >
            ...
            <div className="bg-gradient-to-br from-sky-600 to-indigo-700 text-white p-16 lg:p-24 flex flex-col justify-center items-start text-left relative overflow-hidden">
                ...
                <Button 
                  variant="secondary" 
                  className="bg-white text-indigo-700 hover:bg-indigo-50 hover:shadow-none border-none relative z-10"
                  onClick={onOpenSchoolForm}
                >
